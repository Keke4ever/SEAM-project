...
def notify_callback(notifying, charcteristic):
    if notifying:
            async_tools.add_timer_seconds(3, update_value, charcteristic)
            print("just notifies")
...
def sensor_thread():
        ...
        csv_file =open("sensor_data2.csv" , "w", newline= '')
...
def processing_thread():
    ...
    b, a = signal.butter(4, [lowcut, highcut], btype='bandpass', fs=50)
