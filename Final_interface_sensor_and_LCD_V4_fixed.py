...
_latest_payload = "0,0,STILL,NORMAL"
...
def set_latest_payload(payload: str):
    global _latest_payload
    with _payload_lock:
        _latest_payload = payload

def get_latest_payload_string():
    with _payload_lock:
    ...
    return f"0,0,{activity},{fall_state}"
...
def get_latest_payload():
    try:
        message = get_latest_payload_string()
